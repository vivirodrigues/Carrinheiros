...
def plot_cdf_speed_belem():
    ...
    plt.errorbar(x1, cdf1, ls='-', label='Minimiza trabalho 1', color='tab:red', zorder=3)
    plt.errorbar(x2, cdf2, ls='-', label='Minimiza trabalho 2', color='tab:blue', zorder=3)
    plt.errorbar(x3, cdf3, ls='-', label='Minimiza aclives 1', color='tab:pink', zorder=3)
    plt.errorbar(x4, cdf4, ls='-', label='Minimiza aclives 2', color='tab:green', zorder=3)
    plt.errorbar(x5, cdf5, ls='-', label='Minimiza distância', color='tab:orange', zorder=3)
