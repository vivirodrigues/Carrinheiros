...
def plot_pdf_speed_BH():
    ...
    lim_x_inf = 25 #min(min(x1), min(x2), min(x3))
    ...
    plt.bar(x1[lim_x_inf:lim_x_sup] + 0.5 * space, y1[lim_x_inf:lim_x_sup], label='Minimiza trabalho com puni', color='tab:blue', width=0.3)
    plt.bar(x2[lim_x_inf:lim_x_sup] - 0.5 * space, y2[lim_x_inf:lim_x_sup], label='Minimiza trabalho sem puni', color='tab:pink', width=0.3)
    #plt.bar(x3[lim_x_inf:lim_x_sup] + 0.0 * space, y3[lim_x_inf:lim_x_sup], label='Minimiza aclives com', color='tab:red', width=0.3)
    #plt.bar(x4[lim_x_inf:lim_x_sup] + 0.5 * space, y4[lim_x_inf:lim_x_sup], label='Minimiza aclives sem', color='tab:purple', width=0.3)
    #plt.bar(x5[lim_x_inf:lim_x_sup] - 0.5 * space, y5[lim_x_inf:lim_x_sup], label='Minimiza distancia com', color='tab:green', width=0.3)
