from rascunhos import Coordinates, Overpass, JsonOverpass, DownloadOsm
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dirOSM', metavar='t', type=str, nargs=1, default=["../geography/"], action='store',
                        help='GeoTiff Directory')
    parser.add_argument('--dirGeo', metavar='t', type=str, nargs=1, default=["../GEOTIFF/"], action='store',
                        help='OSM Directory')
    parser.add_argument("--dirModels", metavar='t', type=str, nargs=1, default=["../classes/"], action='store',
                        help='Data directory')
    parser.add_argument("--dirDB", metavar='t', type=str, nargs=1, default=["../classes/DB/"], action='store',
